...
public class CookieManagerModule extends ReactContextBaseJavaModule {
    ...
    public void set(ReadableMap options, final Callback callback) throws Exception {
        ...
        Log.d("COOKIE", "SET");
         ...
         cm.setCookie("https://qatest.labarchives.com/attachments/inline_image/NDg0Mi41fDM3MjUvMzcyNS9Ob3RlYm9vay80MTMxNDU4OTU0fDEyMjkyLjU=?ep_id=MTMuMHwzNzI1LzEwL0VudHJ5UGFydC83OTEzMTA3MjV8MzMuMA%3D%3D&amp;file_name=1497514439338.png", "laapp=" + value);
